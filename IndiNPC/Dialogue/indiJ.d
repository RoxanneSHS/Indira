...
I_C_T2 %er_tutu%jamie 0 j#SamanthaJamie
  == J#IndiJ IF ~IsValidForPartyDialog("J#Indi")~ THEN
     @68
END
...
I_C_T2 %er_tutu%kagain 2 j#kagain_indi
  == J#IndiJ IF ~IsValidForPartyDialog("J#Indi")~ THEN
     @69
END
...
I_C_T2 %er_tutu%kerrac 2 j#kerrac_indi
  == J#IndiJ IF ~IsValidForPartyDialog("J#Indi")~ THEN
     @70
END
...
I_C_T2 %er_tutu%kevin 1 j#kevin_indi
  == J#IndiJ IF ~IsValidForPartyDialog("J#Indi")~ THEN
     @72
END
...
I_C_T2 %er_tutu%kirian 4 j#kirian_indi
  == J#IndiJ IF ~IsValidForPartyDialog("J#Indi")~ THEN
     @73
END


I_C_T2 %er_tutu%korax 3 j#korax_indi
  == J#IndiJ IF ~IsValidForPartyDialog("J#Indi")~ THEN
     @74
END


I_C_T2 %er_tutu%laerta 1 j#laerta_indi
  == J#IndiJ IF ~IsValidForPartyDialog("J#Indi")~ THEN
     @75
END


I_C_T2 %er_tutu%larria 6 j#larria_indi
  == J#IndiJ IF ~IsValidForPartyDialog("J#Indi")~ THEN
     @76
END


I_C_T2 %er_tutu%laskal 4 j#laskal_indi
  == J#IndiJ IF ~IsValidForPartyDialog("J#Indi")~ THEN
     @77
END


I_C_T2 %er_tutu%maple 1 j#maple_indi
  == J#IndiJ IF ~IsValidForPartyDialog("J#Indi")~ THEN
     @78
END


I_C_T2 %er_tutu%marale 13 j#marale_indi
  == J#IndiJ IF ~IsValidForPartyDialog("J#Indi")~ THEN
     @79
END
